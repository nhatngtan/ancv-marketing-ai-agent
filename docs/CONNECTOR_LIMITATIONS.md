...
| Website | WordPress 6.8, REST root và Application Password discovery PASS; create/media routes được quảng bá | Credential, `/users/me`, create/update/media/category/tag request thật | Semi-automatic |
...
WordPress credentials không được commit hoặc đưa vào Cloud Run cho đến khi cả hai secret có version enabled. Application Password phải thuộc user kỹ thuật có quyền tối thiểu, có thể revoke độc lập với mật khẩu đăng nhập.
